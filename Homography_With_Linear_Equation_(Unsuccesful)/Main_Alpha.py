...
print('L4')
print('Obj')
a4Obj, b4Obj, c4Obj = findabc([7,14.4],[42.6,14])
print('Img')
a4Img, b4Img, c4Img = findabc([355,53],[229,67])
print('')

#L5
print('L5')
print('Obj')
a5Obj, b5Obj, c5Obj = findabc([52,1],[54,69.6])
print('Img')

a5Img, b5Img, c5Img = findabc([194,50],[209,203])
print('')
...
print('L7')
print('Obj')
a7Obj, b7Obj, c7Obj = findabc([26.5,6],[19,98.5])
print('Img')
a7Img, b7Img, c7Img = findabc([282,46],[404,277])
print('')
...
objL = np.float32([#[a1Obj, b1Obj, c1Obj],[a2Obj,b2Obj, c2Obj],[a3Obj, b3Obj, c3Obj],
                    [a4Obj, b4Obj, c4Obj],
...
imgL = np.float32([#[a1Img, b1Img, c1Img],a2Img,b2Img, c2Img], [a3Img, b3Img, c3Img],
                    [a4Img, b4Img, c4Img],
